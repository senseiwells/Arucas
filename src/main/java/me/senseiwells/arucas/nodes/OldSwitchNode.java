...
public class OldSwitchNode extends Node {
	private final List<Set<Object>> matches;
	private final List<Node> cases;
	private final Node valueNode;
	private final Node defaultCase;

	public OldSwitchNode(Node valueNode, Node defaultCase, List<Set<Object>> matches, List<Node> cases, ISyntax startPos, ISyntax endPos) {
