...
public class ValueConverter {
	final Map<Class<?>, Functions.BiFunction<?, Context, Value>> converterMap;
	 ...
	 */
	public <T> void addClass(Class<T> clazz, Functions.BiFunction<T, Context, Value> converter) {
	 ...
	 */
	public void addArrayConversion(Functions.BiFunction<Object[], Context, Value> converter) {
	...
	public <T extends S, S> Value convertFrom(final T object, Context context) throws CodeError {
		...
		while (clazz != Object.class) {
			...
			Functions.BiFunction<S, Context, Value> converter = (Functions.BiFunction<S, Context, Value>) this.converterMap.get(clazz);
			if (converter != null) {
		...
		for (Class<?> iClass : baseClazz.getInterfaces()) {
			@SuppressWarnings("unchecked")
			Functions.BiFunction<S, Context, Value> converter = (Functions.BiFunction<S, Context, Value>) this.converterMap.get(iClass);
			if (converter != null) {
				return converter.apply(object, context);
			}
		}
