...
public class BenchmarkArucasMap {
	...
	private static List<Time> benchmark_java_map(final int STEPS, final int WARMUP, final int MAX_VALUE, Random random) {
		final double TIME = 1.0 / (double) STEPS;
		final double WARMUP_TIME = 1.0 / (double) WARMUP;
		List<Time> times = new ArrayList<>();
	...
	private static class Time {
		...
		public String toString() {
			return String.format(Locale.US, this.format, this.time);
		}
	}
